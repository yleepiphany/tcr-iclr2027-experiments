#!/usr/bin/env python3
"""Isolated native RoboTwin TCR formal panel after pass-B row recovery."""
...
BUILD = BASE / "tcr-build-attempt-04"
OLD_FORMAL = BASE / "tcr-formal-attempt-04"
MODELS = BASE / "tcr-checkpoints-v2"
RUN = BASE / "tcr-formal-attempt-05"
