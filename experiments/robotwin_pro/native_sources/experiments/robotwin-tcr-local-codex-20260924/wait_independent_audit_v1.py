#!/usr/bin/env python3
"""Run the independent RoboTwin table audit once both local queues end cleanly."""
...
WAIT = BASE / "independent-audit-waiter-v1"
BUILD_END = BASE / "tcr-build-attempt-01/queue-ended.json"
FORMAL_END = BASE / "tcr-formal-attempt-02/queue-ended.json"
AUDITOR = WORK / "coordination/2026-09-23/audit-robotwin-tcr-local-v1.py"
SOURCES = (AUDITOR, Path(__file__), BASE / "transfer-accept.json",
           BASE / "tcr-build-attempt-01/plan.json",
           BASE / "tcr-formal-attempt-02/plan.json")
POLL_SECONDS = 300
