#!/usr/bin/env python3
"""Run independent RoboTwin A-recovery audit once both new queues end cleanly."""
...
WAIT = BASE / "independent-audit-waiter-v3"
BUILD_END = BASE / "tcr-build-attempt-03/queue-ended.json"
FORMAL_END = BASE / "tcr-formal-attempt-04/queue-ended.json"
AUDITOR = WORK / "coordination/2026-09-23/audit-robotwin-tcr-local-v3.py"
SOURCES = (AUDITOR, Path(__file__), BASE / "transfer-accept.json",
           BASE / "tcr-build-attempt-03/plan.json",
           BASE / "tcr-formal-attempt-04/plan.json")
POLL_SECONDS = 300
