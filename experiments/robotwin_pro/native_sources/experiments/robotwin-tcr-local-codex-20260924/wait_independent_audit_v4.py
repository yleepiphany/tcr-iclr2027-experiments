#!/usr/bin/env python3
"""Run independent RoboTwin B-row recovery audit once both queues end cleanly."""
...
WAIT = BASE / "independent-audit-waiter-v4"
BUILD_END = BASE / "tcr-build-attempt-04/queue-ended.json"
FORMAL_END = BASE / "tcr-formal-attempt-05/queue-ended.json"
AUDITOR = WORK / "coordination/2026-09-23/audit-robotwin-tcr-local-v4.py"
SOURCES = (AUDITOR, Path(__file__), BASE / "transfer-accept.json",
           BASE / "tcr-build-attempt-04/plan.json",
           BASE / "tcr-formal-attempt-05/plan.json")
POLL_SECONDS = 300
