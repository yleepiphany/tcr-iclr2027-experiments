...
def prepare():
    ...
    rows=gpu_rows()
    plan={'schema':'fig4_featcal_single_permit_queue_v1','created_at':now(),'master_plan_sha256':MASTER_SHA,
    ...
    write(RUN/'PERMIT-TEMPLATE-NOT-AUTHORIZED.json',{'schema':'fig4_featcal_queue_execution_permit_v1','allowed':False,
...
def validate_permit(permit,p,digest):
    expected={'schema':'fig4_featcal_queue_execution_permit_v1','allowed':True,'queue_plan_sha256':digest,
            ...
            while pending or active:
                ...
                for gpu in GPUS:
                    ...
                    try:
                        ...
                        process=spawn_owned(command,environment(gpu),log,leases)
