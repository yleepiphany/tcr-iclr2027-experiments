...
def load_replay_states(tensor_path, manifest_path, expected_task, device,
    ...
    from smoothing_contract import SCHEMA, digest
...
def main() -> None:
    ...
    from smoothing_contract import validate_recipe, validate_realized_rows, validate_trace
    ...
    if tuple(experts) != ORIGINAL_EXPERT_ORDER:
        raise ValueError(
            "Original RegMean++ requires --expert order spatial,object,goal,long"
        )
    ...
    manifest = {
        ...
        "method": "pi05_regmeanpp_alpha03_static_t1_mean_centered_spectral_smoothing_v1",
        "training": False,
        "table1_method": "RegMean++ with disclosed spectral smoothing",
        "experiment_manifest": {
        ...
        "calibration_source": "200 static demonstration observations plus independent initial Gaussian noise at t=1",
        ...
        "zero_support_tie_break": "uniform_four_expert_weight_mean",
