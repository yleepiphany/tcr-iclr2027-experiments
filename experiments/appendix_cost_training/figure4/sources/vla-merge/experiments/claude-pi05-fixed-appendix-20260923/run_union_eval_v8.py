#!/usr/bin/env python3
"""Formal repeat-01 400-episode evaluation of the one-pass A∪B control."""
...
BUILDS = ROOT / "union-build-attempt-02"
...
def prepare() -> dict:
    ...
    frozen = {"schema": "pi05_fixed_appendix_union_formal_eval_v1",
              ...
              "recovery_of": "attempt-01 dependency state-file startup race; no GPU worker launched",
