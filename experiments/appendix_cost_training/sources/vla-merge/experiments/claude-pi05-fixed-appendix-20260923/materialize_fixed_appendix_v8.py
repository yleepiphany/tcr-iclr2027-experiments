...
def main() -> None:
    ...
    if ablation is None or ablation.get('schema') != 'pi05_fixed_appendix_ab_reference_v1':
        raise ValueError('This isolated solver accepts only the fixed appendix A->B reference')
    full_ridges = {}
    if ablation is None:
