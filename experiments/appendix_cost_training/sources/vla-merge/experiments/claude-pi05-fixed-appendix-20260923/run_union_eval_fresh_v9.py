#!/usr/bin/env python3
"""Formal repeat-01 evaluation of a fresh corrected A∪B build."""
...
BUILDS = ROOT / "union-build-attempt-03"
RUN = ROOT / "union-formal-eval-fresh-v9"
...
def prepare() -> dict:
    ...
    frozen = {"schema": "pi05_fixed_appendix_union_formal_eval_v1",
              ...
              "recovery_of": "fresh v9 build with complete ridge-reference metadata",
