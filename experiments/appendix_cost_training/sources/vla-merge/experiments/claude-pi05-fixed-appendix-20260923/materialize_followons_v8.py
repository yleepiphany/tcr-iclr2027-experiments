#!/usr/bin/env python3
"""Isolated full-scope solver for A-parent fixed appendix follow-ons.
...
def main() -> None:
    ...
    if ablation is None or ablation.get('schema') != 'pi05_fixed_appendix_followon_v2':
        raise ValueError('This isolated solver accepts only registered A-parent follow-ons')
    full_ridges = {}
    if ablation is None:
        ...
        import appendix_followon_contract_v8 as followon
