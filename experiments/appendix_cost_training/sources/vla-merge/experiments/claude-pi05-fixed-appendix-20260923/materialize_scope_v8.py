#!/usr/bin/env python3
"""Isolated solver for fixed action-only and conditioning+action scopes.
...
def main() -> None:
    ...
    if ablation is None or ablation.get('schema') != 'pi05_fixed_appendix_scope_v5':
        raise ValueError('This isolated solver accepts only registered scope controls')
    full_ridges = {}
    if ablation is None:
        ...
        import appendix_scope_contract_v8 as appendix
